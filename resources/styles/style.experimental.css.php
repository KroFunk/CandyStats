...
.glossyButton{
    ...
    padding:10px;
    font-size:18px;
    /* Permalink - use to edit and share this gradient: https://colorzilla.com/gradient-editor/#5117a9+0,965ae1+100 */
    background: #5117a9; /* Old browsers */
    background: -moz-linear-gradient(-45deg,  #5117a9 0%, #965ae1 100%); /* FF3.6-15 */
    background: -webkit-linear-gradient(-45deg,  #5117a9 0%,#965ae1 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(135deg,  #5117a9 0%,#965ae1 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#5117a9', endColorstr='#965ae1',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
...
.smallglossyButton{
    ...
    padding:5px;
    font-size:12px;
/* Permalink - use to edit and share this gradient: https://colorzilla.com/gradient-editor/#9d0ffc+0,5400ff+100 */
background: #9d0ffc; /* Old browsers */
background: -moz-linear-gradient(-45deg,  #9d0ffc 0%, #5400ff 100%); /* FF3.6-15 */
background: -webkit-linear-gradient(-45deg,  #9d0ffc 0%,#5400ff 100%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(135deg,  #9d0ffc 0%,#5400ff 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#9d0ffc', endColorstr='#5400ff',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
...
/* Permalink - use to edit and share this gradient: https://colorzilla.com/gradient-editor/#6b0df9+0,9d6cf7+100 */
background: #6b0df9; /* Old browsers */
background: -moz-linear-gradient(-45deg,  #6b0df9 0%, #9d6cf7 100%); /* FF3.6-15 */
background: -webkit-linear-gradient(-45deg,  #6b0df9 0%,#9d6cf7 100%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(135deg,  #6b0df9 0%,#9d6cf7 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#6b0df9', endColorstr='#9d6cf7',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */

}
.smallglossyButton:hover{
/* Permalink - use to edit and share this gradient: https://colorzilla.com/gradient-editor/#9d0ffc+49,5400ff+100 */
background: #9d0ffc; /* Old browsers */
background: -moz-linear-gradient(-45deg,  #9d0ffc 50%, #5400ff 100%); /* FF3.6-15 */
background: -webkit-linear-gradient(-45deg,  #9d0ffc 50%,#5400ff 100%); /* Chrome10-25,Safari5.1-6 */
background: linear-gradient(135deg,  #9d0ffc 50%,#5400ff 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#9d0ffc', endColorstr='#5400ff',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
...
box-shadow: #9d0ffc 0px 0px 10px;
}
.menuBar{
    width:100%;
    position:fixed;
