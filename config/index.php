...
<div class='bodyWrapper'>
  ...
  <div class='contentDiv'>
    ...
    <tr>
      ...
      <td align='right'><img src='../resources/images/weapons/Csgo-weapon-revolver.png' class='gunIcon' /> Revolver</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>
      <td align='right'><img src='../resources/images/weapons/Sawedoff.png' class='gunIcon' /> Sawed-Off</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>    
    </tr>
    <tr>
      <td align='right'><img src='../resources/images/weapons/Scar20.png' class='gunIcon' /> SCAR-20</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>
      <td align='right'><img src='../resources/images/weapons/Sg556.png' class='gunIcon' /> SG 553</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>' /></td>
      <td align='right'><img src='../resources/images/weapons/Ssg08.png' class='gunIcon' /> SSG 08</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>
      <td align='right'><img src='../resources/images/weapons/Taserhud.png' class='gunIcon' /> Zeus(Taser)</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>    
    </tr>
    <tr>
      <td align='right'><img src='../resources/images/weapons/Tec9.png' class='gunIcon' /> TEC-9</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>
      <td align='right'><img src='../resources/images/weapons/Ump45go.png' class='gunIcon' /> UMP-45</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>
      <td align='right'><img src='../resources/images/weapons/CSGO_USP-S_Inventory.png' class='gunIcon' /> USP</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>
      <td align='right'><img src='../resources/images/weapons/CSGO_XM1014_Inventory.png' class='gunIcon' /> XM1014</td><td width='70px'><input class='configNumber' onchange='setOneNumberDecimal(this)' type='number' min='0.1' max='2' step='0.1' name='' value='<?php echo $weaponWeighting['']?>'  /></td>    
    </tr>
    </table>
